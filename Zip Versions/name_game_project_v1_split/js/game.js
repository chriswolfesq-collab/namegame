  ...
  try{
    ...
    if(res.ok){
      ...
      if(data && data.title && data.type !== 'disambiguation'){
        ...
        return {valid:true, title:data.title, description:detail, photo:data.thumbnail&&data.thumbnail.source?data.thumbnail.source:''};
      }
    }
    ...
    if(best && best.title){
      ...
      return {valid:true, title:best.title, description:best.description || '', photo:''};
    }
